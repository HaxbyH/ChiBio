 ...
 function updateData(data){
         ...
         document.getElementById('dynamicOutputFile').innerHTML = data.Experiment.prefix + ' ' + data.Experiment.startTime;
          ...
          if (data.Experiment.startTime === " Waiting ") {
               document.getElementById('setPrefixButton').disabled = false; // Active if "Waiting"
           } else {
               document.getElementById('setPrefixButton').disabled = true;  // Disabled if not "Waiting"
           }
         ...
         document.getElementById("InoculationStartTime").innerHTML = data.Inoculation.startTime;
         ...
         if (data.Inoculation.ON){
           document.getElementById("InoculationRunningIndicator").setAttribute("class", "btn btn-success")
           document.getElementById("InoculationRunningIndicator").innerHTML= "&nbsp &nbsp &nbsp   Inoculated   &nbsp &nbsp &nbsp"
         } else {
           document.getElementById("InoculationRunningIndicator").setAttribute("class", "btn btn-danger")
           document.getElementById("InoculationRunningIndicator").innerHTML=  "&nbsp &nbsp &nbsp   Waiting   &nbsp &nbsp &nbsp"
         }
         ...
         document.getElementById("InoculationStart").disabled = !running;
         if (data.Inoculation.ON == 1) {
                document.getElementById("InoculationStart").disabled = Boolean(1);
         }
      ...
      if (data.LEDV.ON==1){
         ...
         document.getElementById("Pump1Switch").disabled = true;
         document.getElementById("Pump2Switch").disabled = true;
         document.getElementById("Pump3Switch").disabled = true;
         document.getElementById("Pump4Switch").disabled = true;
         
         document.getElementById("Pump1Set").disabled = true;
         document.getElementById("Pump2Set").disabled = true;
         document.getElementById("Pump3Set").disabled = true;
         document.getElementById("Pump4Set").disabled = true;
         
         document.getElementById("Pump1Direction").disabled = true;
         document.getElementById("Pump2Direction").disabled = true;
         document.getElementById("Pump3Direction").disabled = true;
         document.getElementById("Pump4Direction").disabled = true;
     //     if (data.Pump1.ON==1){
